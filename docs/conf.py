...
htmlhelp_basename = 'gspread_asynciodoc'
...
latex_documents = [
    (master_doc, 'gspread_asyncio.tex', 'gspread\\_asyncio Documentation',
     'David Gilman', 'manual'),
]
...
man_pages = [
    (master_doc, 'gspread_asyncio', 'gspread_asyncio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gspread_asyncio', 'gspread_asyncio Documentation',
     author, 'gspread_asyncio', 'One line description of project.',
     'Miscellaneous'),
]
